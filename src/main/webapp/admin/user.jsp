...
<body>
   ...
   <div id="ToolBar">
       ...
       <div>
           姓名:<input type="text" id="ssname" name="name">
           电话:<input type="text" id="sstel" name="telephone">
           开始年龄:<input type="text" id="ssstartage" name="startAge">
           结束年龄:<input type="text" id="ssendage" name="endAge">
